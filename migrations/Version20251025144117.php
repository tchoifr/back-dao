 ...
 */
final class Version20251025144117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job (id BINARY(16) NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, budget NUMERIC(18, 2) NOT NULL, currency VARCHAR(10) NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, recruiter_id BINARY(16) NOT NULL, INDEX IDX_FBD8E0F8156BE243 (recruiter_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user (id BINARY(16) NOT NULL, wallet_address VARCHAR(255) NOT NULL, username VARCHAR(100) DEFAULT NULL, role VARCHAR(20) NOT NULL, user_token VARCHAR(255) DEFAULT NULL, network VARCHAR(20) NOT NULL, sol_balance NUMERIC(18, 8) DEFAULT NULL, eth_balance NUMERIC(18, 8) DEFAULT NULL, work_balance NUMERIC(18, 8) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D6497C4F4A97 (wallet_address), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
